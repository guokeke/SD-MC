...
public class PartitionedReachedSet extends DefaultReachedSet {
  ...
  public Collection<AbstractState> getReached(AbstractState pState) {
    //System.out.println(getPartitionKey(pState).toString());
    //System.out.println("partitionedReached.keySet().size()=>"+partitionedReached.keySet().size());
  ...
  protected Collection<AbstractState> getReachedForKey(Object key) {
   ...
   // System.out.println("partitionedReached.get(key)=>"+partitionedReached.get(key));
