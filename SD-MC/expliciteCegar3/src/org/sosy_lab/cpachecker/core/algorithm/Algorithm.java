...
public interface Algorithm {
  ...
  public Pair<ARGState, ARGState> run(ReachedSet pReached, Proposition pProposition,Set<CFANode> loopHead, CFA pCfa) throws InterruptedException, CPAException, IOException, InvalidConfigurationException;
