...
public class ARGCPA extends AbstractSingleWrapperCPA implements ConfigurableProgramAnalysisWithABM, ProofChecker {
  ...
  public void printClassName(){
    ...
    System.out.println(precisionAdjustment.getClass().toString());
    System.out.println(mergeOperator.getClass().toString());
    System.out.println(stopOperator.getClass().toString());
    System.out.println(reducer.getClass().toString());
    //System.out.println();
