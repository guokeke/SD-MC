...
//具体细化=========================================================================================1
  @Override
  public CounterexampleInfo performRefinementForProperty(AbstractState successor,Proposition proposition,String checkType,boolean b)throws CPAException, InterruptedException{
    return performRefinementWithInfoForProperty(successor,proposition,checkType,b);
  }
  private CounterexampleInfo performRefinementWithInfoForProperty(AbstractState pSuccessor, Proposition pProposition,String checkType,boolean b) throws CPAException, InterruptedException {
    ...
    //AbstractState lastElement = pSuccessor.getLastState();
   ...
   // assert ((ARGState)lastElement).isTarget() : "Last element in reached is not a target state before refinement";
    //ARGReachedSet reached = new ARGReachedSet(pSuccessor);
   ...
   /* if (logger.wouldBeLogged(Level.ALL) && path != null) {
    ...
    CFANode loc=AbstractStates.extractLocation(pSuccessor);
    CounterexampleInfo counterexample;
    counterexample = performRefinementForProperty(pSuccessor, loc,pProposition,checkType,b);
   // System.out.println("counterexample=>"+counterexample.isSpurious());
  ...
  protected abstract CounterexampleInfo performRefinementForProperty(AbstractState pSuccessor, CFANode pLoc, Proposition pProposition, String checkType,boolean pB) throws CPAException, InterruptedException;
  //protected abstract CounterexampleInfo performRefinementForPointer(AbstractState pSuccessor, CFANode pLoc, Proposition pProposition, String checkType,boolean pB) throws CPAException, InterruptedException;
...
//具体细化============================================================================================2
   ...
   * but it returns some more information about the refinement(ReachedSet)}
   */
