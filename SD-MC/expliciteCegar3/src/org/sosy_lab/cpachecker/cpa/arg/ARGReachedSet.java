...
//    mUnmodifiableReached = new UnmodifiableReachedSetWrapper(mReached);
  ...
  public void removeSubtree1(ARGState e) {
   ...
   // MyInfo.stack.removeAll(toUnreach);
  }
  /**
   ...
   */
  public Precision adaptPrecision(ARGState pARGState, Precision pNewPrecision) {
  ...
  private Set<ARGState> removeSubtree0(ARGState e) {
    ...
    toUnreach.addAll(newToUnreach);
    ((DefaultReachedSet)mReached).map.clear();
