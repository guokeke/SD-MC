...
public class CompositeStopOperator implements StopOperator, ForcedCoveringStopOperator {
  ...
  private boolean stop(CompositeState compositeState, CompositeState compositeReachedState, CompositePrecision compositePrecision) throws CPAException {
    ...
    //System.out.println("-----------------------------------------");
    //System.out.println("compositeElements=>"+compositeElements);
    //System.out.println(compositeElements.size());
    //System.out.println("compositeReachedStates=>"+compositeReachedStates);
    //System.out.println("-----------------------------------------");
    ...
    for (int idx = 0; idx < compositeElements.size(); idx++) {
      ...
      //System.out.println("absElem1=>"+absElem1);
      //System.out.println("absElem2=>"+absElem2);
      //System.out.println("stopOp=>"+stopOp.getClass().toString());
      //System.out.println("prec=>"+prec);
      if (!stopOp.stop(absElem1, Collections.singleton(absElem2), prec)){
        //System.out.println("Composite.return=false");
        return false;
      }
    }
    return true;
