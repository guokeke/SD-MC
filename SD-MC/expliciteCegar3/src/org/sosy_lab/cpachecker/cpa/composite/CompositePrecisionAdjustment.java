...
public class CompositePrecisionAdjustment implements PrecisionAdjustment {
  ...
  public Triple<AbstractState, Precision, Action> prec(AbstractState pElement,
    ...
    int j=0;
    for (int i = 0; i < dim; ++i) {
      //System.out.println("stateProjectionFunctions=>"+stateProjectionFunctions.get(i));
      //System.out.println("precisionProjectionFunctions=>"+precisionProjectionFunctions.get(i));
    ...
    AbstractState outElement = modified1 ? new CompositeState(outElements.build())     : pElement;
    Precision outPrecision     = modified1? new CompositePrecision(outPrecisions.build()) : pPrecision;
