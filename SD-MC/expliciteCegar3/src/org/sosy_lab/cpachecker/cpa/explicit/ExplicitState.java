...
public class ExplicitState implements AbstractQueryableState, FormulaReportingState, Serializable {
  ...
  boolean isLessOrEqual(ExplicitState other) {
    ...
    //System.out.println("constantsMap=>"+constantsMap.keySet());
    //System.out.println("other.constantsMap=>"+other.constantsMap.keySet());
    ...
    for (Map.Entry<String, Long> otherEntry : other.constantsMap.entrySet()) {
     ...
     // System.out.println("value1=>"+otherEntry.getValue());
     // System.out.println("value2=>"+constantsMap.get(key));
      if (!otherEntry.getValue().equals(constantsMap.get(key))) {
       // System.out.println("Explicit.return=false");
        return false;
      }
    }
