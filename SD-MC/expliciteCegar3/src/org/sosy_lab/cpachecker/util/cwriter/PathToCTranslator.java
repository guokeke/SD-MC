...
public class PathToCTranslator {
  ...
  private String startFunction(ARGState firstFunctionElement, Stack<FunctionBody> functionStack) {
    ...
    //System.out.println(extractLocation(firstFunctionElement).getClass().toString());
    //System.out.println(firstFunctionElement);
    CFunctionEntryNode functionStartNode = (CFunctionEntryNode)((FunctionEntryNode)extractLocation(firstFunctionElement));
