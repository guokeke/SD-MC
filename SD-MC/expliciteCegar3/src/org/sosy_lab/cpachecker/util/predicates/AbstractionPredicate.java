...
public class AbstractionPredicate {
  ...
  public String toString() {
   // System.out.println(abstractVariable.getClass().toString());
   // System.out.println(symbolicVariable.getClass().toString());
   // System.out.println(symbolicAtom.getClass().toString());
