...
public class CachingPathFormulaManager implements PathFormulaManager {
  ...
  public PathFormula makeAnd(PathFormula pOldFormula, CFAEdge pEdge) throws CPATransferException {
    ...
    PathFormula result = null;//pathFormulaCache.get(formulaCacheKey);
   // if (result == null) {
  ...
  @Override
  public PathFormula makeAnd1(PathFormula pOldFormula, CFAEdge pEdge) throws CPATransferException {

   // final Pair<PathFormula, CFAEdge> formulaCacheKey = Pair.of(pOldFormula, pEdge);
    PathFormula result = null;//pathFormulaCache.get(formulaCacheKey);//mycode
   // if (result == null) {
      pathFormulaComputationTimer.start();
      // compute new pathFormula with the operation on the edge
      result = delegate.makeAnd(pOldFormula, pEdge);
  ...
  public PathFormula makeAnd1(PathFormula pOldFormula, CFAEdge pEdge,String fun) throws CPATransferException {
