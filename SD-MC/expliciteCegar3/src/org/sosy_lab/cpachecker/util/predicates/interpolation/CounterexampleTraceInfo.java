...
public class CounterexampleTraceInfo<I> {
    private boolean spurious;//去掉了final
    ...
    private List<Formula> interpolants;
    ...
    public CounterexampleTraceInfo() {
      ...
      interpolants=Collections.emptyList();//mycode
    ...
    public List<Formula> getInterpolants() {
      return interpolants;
    }


    public void setInterpolants(List<Formula> pInterpolants) {
      interpolants = pInterpolants;
    }


    public void setSpurious(boolean pSpurious) {
      spurious = pSpurious;
    }
